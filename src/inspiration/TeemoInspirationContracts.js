(function (root, factory) {
  ...
  const ERROR_CODES = Object.freeze({
    ...
    indexNotFound: 'INSPIRATION_INDEX_NOT_FOUND',
    indexBusy: 'INSPIRATION_INDEX_BUSY',
    indexChanged: 'INSPIRATION_INDEX_CHANGED',
    indexCorrupt: 'INSPIRATION_INDEX_CORRUPT',
    indexUnreadable: 'INSPIRATION_INDEX_UNREADABLE',
    indexLimitExceeded: 'INSPIRATION_INDEX_LIMIT_EXCEEDED',
    indexStorageLimit: 'INSPIRATION_INDEX_STORAGE_LIMIT',
    indexFailed: 'INSPIRATION_INDEX_FAILED',
  ...
  function publicError(error) {
    ...
    const messages = {
      ...
      [ERROR_CODES.indexNotFound]: '该灵感来源尚未建立索引',
      [ERROR_CODES.indexBusy]: '灵感索引正在更新，请稍后重试',
      [ERROR_CODES.indexChanged]: '灵感索引已在其他窗口更新，请刷新后重试',
      [ERROR_CODES.indexCorrupt]: '该素材来源的索引已损坏，需要重建',
      [ERROR_CODES.indexUnreadable]: '灵感索引状态无法读取，已安全停用',
      [ERROR_CODES.indexLimitExceeded]: '灵感来源超过索引安全限制',
      [ERROR_CODES.indexStorageLimit]: '灵感索引超过本地存储限制',
      [ERROR_CODES.indexFailed]: '灵感索引未能完成，旧索引保持不变',
